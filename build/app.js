...
app.config(function ($routeProvider, ngMetaProvider) {
  $routeProvider.when("/", {
    ...
    data: {
      meta: {
        title: 'Neurostone Developer History Resources',
        description: 'Video game developer Neurostone official history and archives. Swedens first game console developer with releases on Sega mega-drive and Sony Playstation.'
      }
    }
  });
  $routeProvider.when("/elitserien-95/screenshots", {
    ...
    data: {
      meta: {
        ...
        description: 'Elitserien 95, developed in 1994 by Neurostone and High Score Productions. A ice hockey game adopted to the swedish hockey leauge on Sega Mega-drive.'
      }
    }
  });
  $routeProvider.when("/elitserien-95/reviews", {
    ...
    data: {
      meta: {
        ...
        description: 'Reviews of Elitserien 95, One of the best selling games for sega mega-drive in sweden at lauch, it topped the list as number 1 just above Nhl 95.'
      }
    }
  });
  $routeProvider.when("/elitserien-96/screenshots", {
    ...
    data: {
      meta: {
        ...
        description: 'Elitserien 96, developed in 1995 by Neurostone and High Score Productions. A follow up to the previous ice hockey game on Sega Mega-drive.'
      }
    }
  });
  $routeProvider.when("/auto-destruct/screenshots", {
    ...
    data: {
      meta: {
        ...
        description: 'Auto destruct developed by Neurostone 1995 - 1997, and published on Sony Playstation in December 1997 / January 1998 by Electronic Arts.'
      }
    }
  });
  $routeProvider.when("/auto-destruct/reviews", {
    ...
    data: {
      meta: {
        ...
        description: 'Auto destruct was one of the most under estimated games ever released for the Sony Playstation, and those who bought it, ended up loving the game.'
      }
    }
  });
  $routeProvider.when("/archive/photos", {
    ...
    data: {
      meta: {
        title: 'Archive Photos - During development of Auto destruct',
        description: 'Exclusive photos taken during the initial development of auto destruct, shows the team in action, and how development equipment looked back then.'
      }
    }
  });
});
...
var _module_exports = "\r\n    <div layout=\"column\" layout-padding layout-align=\"center center\">\r\n        <div layout-fill>\r\n            <h1>Elitserien 95 - Reviews</h1>\r\n            <p>Reviews of Elitserien 95, One of the best selling games for sega mega-drive in sweden at lauch, it topped the list as number 1 just above Nhl 95.</p>\r\n        </div>\r\n        <div layout=\"row\" layout-padding layout-align=\"center center\">\r\n            <div>\r\n                <img ng-src=\"build/images/elitserien-95/reviews/tvb_1.jpg\">\r\n            </div>\r\n        </div>\r\n    </div>\r\n";;
